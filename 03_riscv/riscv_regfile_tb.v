...
// --------------------------------------------------
	...
	wire	[`REG_DATA_BUS]	o_reg_rd_data0;
	wire	[`REG_DATA_BUS]	o_reg_rd_data1;
	reg		[`REG_ADDR_BUS]	i_reg_rd_addr0;
	reg		[`REG_ADDR_BUS]	i_reg_rd_addr1;
	reg		[`REG_DATA_BUS]	i_reg_wr_data;
	reg		[`REG_ADDR_BUS]	i_reg_wr_addr;
	reg						i_reg_wr_en;
	reg						i_clk;
	reg						i_rstn;
...
// --------------------------------------------------
	...
	task regWR;
		input	[`REG_ADDR_BUS]	ti_reg_wr_addr;
		input	[`REG_DATA_BUS]	ti_reg_wr_data;
		begin
			taskState	= "WR";
			@(negedge i_clk) begin
			//	$display ("==================================================");
	...
	task regRD;
		input	[`REG_ADDR_BUS]	ti_reg_rd_addr0;
		input	[`REG_ADDR_BUS]	ti_reg_rd_addr1;
		begin
			taskState	= "RD";
			@(negedge i_clk) begin
